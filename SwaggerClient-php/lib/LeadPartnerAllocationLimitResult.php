...
/**
 * LeadPartnerAllocationLimitResult Class Doc Comment
 *
 * @category    Class
 * @package     Ageras\Api
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LeadPartnerAllocationLimitResult implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LeadPartnerAllocationLimitResult';
    ...
    protected static $swaggerTypes = [
        ...
        'pages' => 'int',
        'total' => 'int',
        'data' => '\Ageras\Api\LeadPartnerAllocationLimitResource[]',
        'did_you_mean' => 'string'
    ];
    ...
    /**
     * Sets data
     * @param \Ageras\Api\LeadPartnerAllocationLimitResource[] $data The result.
     * @return $this
     */
