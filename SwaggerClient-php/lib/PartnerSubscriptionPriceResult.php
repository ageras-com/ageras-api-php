...
/**
 * PartnerSubscriptionPriceResult Class Doc Comment
 *
 * @category    Class
 * @package     Ageras\Api
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PartnerSubscriptionPriceResult implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartnerSubscriptionPriceResult';
    ...
    protected static $swaggerTypes = [
        ...
        'pages' => 'int',
        'total' => 'int',
        'data' => '\Ageras\Api\PartnerSubscriptionPriceResource[]',
        'did_you_mean' => 'string'
    ];
    ...
    /**
     * Sets data
     * @param \Ageras\Api\PartnerSubscriptionPriceResource[] $data The result.
     * @return $this
     */
