...
class PaymentsolutionsApi
{
     ...
     * @return \Ageras\Api\PaymentSolutionResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\PaymentSolutionResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentsolutionsIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\PaymentSolutionResult',
                '/paymentsolutions'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\PaymentSolutionResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\PaymentSolutionResult', $e->getResponseHeaders());
