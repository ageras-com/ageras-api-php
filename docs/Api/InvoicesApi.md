...
> \Ageras\Api\Model\VoucherRefundRequestResource invoicesRefundrequestsActionsCreate($invoice_id,  $voucher_refund_request_id , $voucher_refund_request_action_resource)
...
$voucher_refund_request_action_resource = new \Ageras\Api\Model\VoucherRefundRequestActionResource(); // \Ageras\Api\Model\VoucherRefundRequestActionResource | 
 ...
 **voucher_refund_request_action_resource** | [**\Ageras\Api\Model\VoucherRefundRequestActionResource**](../Model/VoucherRefundRequestActionResource.md)|  |

### Return type

[**\Ageras\Api\Model\VoucherRefundRequestResource**](../Model/VoucherRefundRequestResource.md)
...
> \Ageras\Api\Model\VoucherRefundRequestResource invoicesRefundrequestsCreate($invoice_id , $voucher_refund_request_resource)
...
$api_instance = new Ageras\Api\Api\InvoicesApi();
$invoice_id = "invoice_id_example"; // string | 
$voucher_refund_request_resource = new \Ageras\Api\Model\VoucherRefundRequestResource(); // \Ageras\Api\Model\VoucherRefundRequestResource | 
...
------------- | ------------- | ------------- | -------------
 **invoice_id** | **string**|  |
 **voucher_refund_request_resource** | [**\Ageras\Api\Model\VoucherRefundRequestResource**](../Model/VoucherRefundRequestResource.md)|  |
...
> \Ageras\Api\Model\VoucherRefundRequestResource invoicesRefundrequestsGet($voucher_refund_request_id )
...
> \Ageras\Api\Model\VoucherRefundRequestResource invoicesRefundrequestsGet2($invoice_id,  $voucher_refund_request_id )
...
> \Ageras\Api\Model\VoucherRefundRequestResult invoicesRefundrequestsIndex($criteria)
...
[**\Ageras\Api\Model\VoucherRefundRequestResult**](../Model/VoucherRefundRequestResult.md)
...
> \Ageras\Api\Model\VoucherRefundRequestResult invoicesRefundrequestsIndex2($voucher_id , $criteria)
