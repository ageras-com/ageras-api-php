...
$order_by = "order_by_example"; // string | Order by price asc or desc.
...
try {
    $result = $api_instance->offersIndex($show_expired, $show_accepted, $partner_id, $order_by, $action, $geo_code, $type, $limit, $page, $query);
    print_r($result);
} catch (Exception $e) {
 ...
 **order_by** | **string**| Order by price asc or desc. | [optional]
