...
# **paymentsCardsCreate**
> \Ageras\Api\Model\PaymentCardResource paymentsCardsCreate($payment_card_resource)
...
------------- | ------------- | ------------- | -------------
 **payment_card_resource** | [**\Ageras\Api\Model\PaymentCardResource**](../Model/PaymentCardResource.md)|  |
