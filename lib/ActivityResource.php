...
class ActivityResource implements ArrayAccess
{
    ...
    const TYPE_PARTNERS_EMPLOYEE_NOTES_CREATE = 'partners_employee_notes_create';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_PARTNERS_EMPLOYEE_NOTES_CREATE,
