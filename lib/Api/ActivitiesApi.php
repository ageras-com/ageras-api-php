...
class ActivitiesApi
{
     ...
     * @return \Ageras\Api\Model\ActivityResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\ActivityResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function activitiesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\ActivityResult',
                '/activities'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\ActivityResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\ActivityResult', $e->getResponseHeaders());
