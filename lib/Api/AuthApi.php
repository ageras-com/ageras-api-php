...
class AuthApi
{
     ...
     *
     * @param \Ageras\Api\Model\AuthResource $auth_resource Authentication Resource with authorize information
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\AuthResource
     */
     ...
     * @param \Ageras\Api\Model\AuthResource $auth_resource Authentication Resource with authorize information
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\AuthResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function authCreateWithHttpInfo($auth_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\AuthResource',
                '/auth'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\AuthResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\AuthResource', $e->getResponseHeaders());
     ...
     *
     * @param \Ageras\Api\Model\PasswordResetResource $password_reset_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\PasswordResetResource
     */
     ...
     * @param \Ageras\Api\Model\PasswordResetResource $password_reset_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\PasswordResetResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function authPasswordCreateWithHttpInfo($password_reset_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\PasswordResetResource',
                '/auth/password'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\PasswordResetResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\PasswordResetResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param \Ageras\Api\Model\PasswordReminderResource $password_reminder_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\PasswordReminderResource
     */
     ...
     * @param \Ageras\Api\Model\PasswordReminderResource $password_reminder_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\PasswordReminderResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function authPasswordreminderCreateWithHttpInfo($password_reminder_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\PasswordReminderResource',
                '/auth/passwordreminder'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\PasswordReminderResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\PasswordReminderResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\PermissionResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\PermissionResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function authPermissionsIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\PermissionResult',
                '/auth/permissions'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\PermissionResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\PermissionResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param \Ageras\Api\Model\AuthResource $auth_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\AuthResource
     */
