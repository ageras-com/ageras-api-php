...
class AuthApi
{
     ...
     *
     * @param \Swagger\Client\Model\AuthResource $auth_resource Authentication Resource with authorize information (required)
     * @return \Swagger\Client\Model\AuthResource
     ...
     *
     * @param \Swagger\Client\Model\AuthResource $auth_resource Authentication Resource with authorize information (required)
     * @return Array of \Swagger\Client\Model\AuthResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function authCreateWithHttpInfo($auth_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\AuthResource',
                '/auth'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AuthResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\AuthResource', $e->getResponseHeaders());
     ...
     *
     * @param \Swagger\Client\Model\PasswordResetResource $password_reset_resource  (required)
     * @return \Swagger\Client\Model\PasswordResetResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     *
     * @param \Swagger\Client\Model\PasswordResetResource $password_reset_resource  (required)
     * @return Array of \Swagger\Client\Model\PasswordResetResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function authPasswordCreateWithHttpInfo($password_reset_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PasswordResetResource',
                '/auth/password'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PasswordResetResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PasswordResetResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param \Swagger\Client\Model\PasswordReminderResource $password_reminder_resource  (required)
     * @return \Swagger\Client\Model\PasswordReminderResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     *
     * @param \Swagger\Client\Model\PasswordReminderResource $password_reminder_resource  (required)
     * @return Array of \Swagger\Client\Model\PasswordReminderResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function authPasswordreminderCreateWithHttpInfo($password_reminder_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PasswordReminderResource',
                '/auth/passwordreminder'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PasswordReminderResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PasswordReminderResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Swagger\Client\Model\PermissionResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\PermissionResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function authPermissionsIndexWithHttpInfo($limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PermissionResult',
                '/auth/permissions'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PermissionResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PermissionResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param \Swagger\Client\Model\AuthResource $auth_resource  (required)
     * @return \Swagger\Client\Model\AuthResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
