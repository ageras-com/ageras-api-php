...
class CertificationsApi
{
     ...
     */
    public function certificationsIndex($criteria = [])
    {
        list($response) = $this->certificationsIndexWithHttpInfo($criteria);
        return $response;
    }
     ...
     */
    public function certificationsIndexWithHttpInfo($criteria = [])
    {
        // parse inputs
