...
class ClientsApi
{
     ...
     * @param string $client_id Id of the client
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\ClientResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function clientsGetWithHttpInfo($client_id )
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\ClientResource',
                '/clients/{client_id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\ClientResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\ClientResource', $e->getResponseHeaders());
     ...
     * @param \Ageras\Api\Model\ClientResource $client_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\ClientResource
     */
