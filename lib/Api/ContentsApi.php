...
class ContentsApi
{
     ...
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\ContentPageResource
     */
     ...
     * @param string $content_page_id 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\ContentPageResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function contentsPagesGetWithHttpInfo($content_page_id )
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\ContentPageResource',
                '/contents/pages/{content_page_id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\ContentPageResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\ContentPageResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\ContentPageResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\ContentPageResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function contentsPagesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\ContentPageResult',
                '/contents/pages'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\ContentPageResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\ContentPageResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\ContentPageTypeResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\ContentPageTypeResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function contentsPagesTypesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\ContentPageTypeResult',
                '/contents/pages/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\ContentPageTypeResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\ContentPageTypeResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
