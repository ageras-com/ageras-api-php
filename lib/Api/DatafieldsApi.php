...
/**
 * DatafieldsApi Class Doc Comment
 *
 * @category Class
 * @package  Ageras\Api
 * @author   Swagger Codegen team
...
class DatafieldsApi
{
     ...
     * @return \Ageras\Api\Model\DataFieldResult
     */
    public function datafieldsIndex($criteria = [])
    {
        list($response) = $this->datafieldsIndexWithHttpInfo($criteria);
        return $response;
    }
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\DataFieldResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function datafieldsIndexWithHttpInfo($criteria = [])
    {
        // parse inputs
        $resourcePath = "/datafields";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        if (isset($criteria['tag'])) {
            $queryParams['tag'] = $this->apiClient->getSerializer()->toQueryValue($criteria['tag']);
        }
        // query params
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\DataFieldResult',
                '/datafields'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\DataFieldResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\DataFieldResult', $e->getResponseHeaders());
