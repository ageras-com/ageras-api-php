...
class IndustriesApi
{
     ...
     * @return \Ageras\Api\Model\IndustryResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\IndustryResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function industriesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\IndustryResult',
                '/industries'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\IndustryResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\IndustryResult', $e->getResponseHeaders());
