...
class IndustriesApi
{
     ...
     * @return \Swagger\Client\Model\IndustryResult
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\IndustryResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function industriesIndexWithHttpInfo($industry_id = null, $name = null, $geo_code = null, $status = null, $limit = null, $parent_industry_id = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\IndustryResult',
                '/industries'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\IndustryResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\IndustryResult', $e->getResponseHeaders());
