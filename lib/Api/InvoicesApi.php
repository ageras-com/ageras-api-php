...
class InvoicesApi
{
     ...
     * @return \Swagger\Client\Model\InvoiceResource
     ...
     *
     * @param string $invoice_id  (required)
     * @return Array of \Swagger\Client\Model\InvoiceResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function invoicesGetWithHttpInfo($invoice_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\InvoiceResource',
                '/invoices/{invoice_id}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InvoiceResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\InvoiceResource', $e->getResponseHeaders());
    ...
    public function invoicesIndexWithHttpInfo($invoice_id = null, $partner_id = null, $is_paid = null, $is_overdue = null, $sort = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InvoiceResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
