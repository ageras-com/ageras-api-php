...
class KpiApi
{
     ...
     * @return \Ageras\Api\Model\KPIResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\KPIResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function kpiIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\KPIResult',
                '/kpi'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\KPIResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\KPIResult', $e->getResponseHeaders());
