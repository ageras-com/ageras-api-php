...
class LanguagesApi
{
     ...
     * @return \Ageras\Api\Model\LanguageResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\LanguageResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function languagesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\LanguageResult',
                '/languages'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\LanguageResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\LanguageResult', $e->getResponseHeaders());
