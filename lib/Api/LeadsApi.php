...
class LeadsApi
{
     ...
     * Create a new Lead.
     *
     * @param \Swagger\Client\Model\LeadResource $lead_resource The given Lead Resource that should be created (required)
     ...
     *
     * @param \Swagger\Client\Model\LeadResource $lead_resource The given Lead Resource that should be created (required)
     * @return Array of \Swagger\Client\Model\LeadResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function leadsCreateWithHttpInfo($lead_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\LeadResource',
                '/leads'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\LeadResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\LeadResource', $e->getResponseHeaders());
     ...
     * @param string $sort Sort Leads by a given attribute. (optional)
     ...
     * @return \Swagger\Client\Model\LeadResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\LeadResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function leadsIndexWithHttpInfo($lead_id = null, $needs_more_offers = null, $phone = null, $filter = null, $partner_id = null, $geo_code = null, $sort = null, $status = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\LeadResult',
                '/leads'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\LeadResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\LeadResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param string $lead_id  (required)
     * @param \Swagger\Client\Model\LeadOfferResource $lead_offer_resource  (required)
     * @return \Swagger\Client\Model\LeadOfferResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $lead_id  (required)
     * @param \Swagger\Client\Model\LeadOfferResource $lead_offer_resource  (required)
     * @return Array of \Swagger\Client\Model\LeadOfferResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function leadsOffersCreateWithHttpInfo($lead_id, $lead_offer_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\LeadOfferResource',
                '/leads/{lead_id}/offers'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\LeadOfferResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\LeadOfferResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return \Swagger\Client\Model\LeadOfferResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\LeadOfferResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function leadsOffersIndexWithHttpInfo($lead_id = null, $lead_offer_id = null, $partner_id = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\LeadOfferResult',
                '/leads/offers'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\LeadOfferResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\LeadOfferResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return \Swagger\Client\Model\LeadTypeResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\LeadTypeResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function leadsTypesIndexWithHttpInfo($type_id = null, $title = null, $geo_code = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\LeadTypeResult',
                '/leads/types'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\LeadTypeResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\LeadTypeResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param string $lead_id  (required)
     * @param \Swagger\Client\Model\LeadResource $lead_resource  (required)
     * @return \Swagger\Client\Model\LeadResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
