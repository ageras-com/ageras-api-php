...
class LocationsApi
{
     ...
     * @return \Ageras\Api\Model\LocationResource
     */
     ...
     * @param string $location_id 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\LocationResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function locationsGetWithHttpInfo($location_id )
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\LocationResource',
                '/locations/{location_id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\LocationResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\LocationResource', $e->getResponseHeaders());
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\LocationResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\LocationResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function locationsIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\LocationResult',
                '/locations'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\LocationResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\LocationResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
