...
class MlApi
{
     ...
     * @return \Ageras\Api\Model\MatchResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\MatchResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function mlMatchingIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\MatchResult',
                '/ml/matching'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\MatchResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\MatchResult', $e->getResponseHeaders());
