...
class OffersApi
{
     ...
     * @param \Swagger\Client\Model\OfferActionResource $offer_action_resource  (required)
     * @return \Swagger\Client\Model\PartnerOfferResource
     ...
     * @param string $offer_id  (required)
     * @param \Swagger\Client\Model\OfferActionResource $offer_action_resource  (required)
     * @return Array of \Swagger\Client\Model\PartnerOfferResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function offersActionsCreateWithHttpInfo($offer_id, $offer_action_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PartnerOfferResource',
                '/offers/{offer_id}/actions'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PartnerOfferResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PartnerOfferResource', $e->getResponseHeaders());
     ...
     * @return \Swagger\Client\Model\PartnerOfferResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\PartnerOfferResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function offersIndexWithHttpInfo($show_expired = null, $show_accepted = null, $partner_id = null, $order_by = null, $action = null, $geo_code = null, $type = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PartnerOfferResult',
                '/offers'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PartnerOfferResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PartnerOfferResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
