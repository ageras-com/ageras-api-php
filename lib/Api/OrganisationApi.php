...
class OrganisationApi
{
     ...
     * @param string $employee_id 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\EmployeeResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function organisationEmployeesGetWithHttpInfo($employee_id )
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\EmployeeResource',
                '/organisation/employees/{employee_id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\EmployeeResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\EmployeeResource', $e->getResponseHeaders());
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\EmployeeResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\EmployeeResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function organisationEmployeesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\EmployeeResult',
                '/organisation/employees'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\EmployeeResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\EmployeeResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\EmployeeKpiResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\EmployeeKpiResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function organisationEmployeesKpiIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\EmployeeKpiResult',
                '/organisation/employees/kpi'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\EmployeeKpiResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\EmployeeKpiResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
