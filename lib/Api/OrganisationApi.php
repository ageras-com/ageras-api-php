...
class OrganisationApi
{
     ...
     * @return \Swagger\Client\Model\EmployeeResource
     ...
     *
     * @param string $employee_id  (required)
     * @return Array of \Swagger\Client\Model\EmployeeResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function organisationEmployeesGetWithHttpInfo($employee_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\EmployeeResource',
                '/organisation/employees/{employee_id}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\EmployeeResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\EmployeeResource', $e->getResponseHeaders());
     ...
     * @return \Swagger\Client\Model\EmployeeResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\EmployeeResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function organisationEmployeesIndexWithHttpInfo($employee_id = null, $geo_code = null, $limit = null, $role_id = null, $sort = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\EmployeeResult',
                '/organisation/employees'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\EmployeeResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\EmployeeResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
