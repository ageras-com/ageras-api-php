...
class PaymentsApi
{
     ...
     * @return \Swagger\Client\Model\PaymentCardResource
     ...
     *
     * @param string $payment_card_id  (required)
     * @return Array of \Swagger\Client\Model\PaymentCardResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function paymentsCardsGetWithHttpInfo($payment_card_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PaymentCardResource',
                '/payments/cards/{payment_card_id}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PaymentCardResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PaymentCardResource', $e->getResponseHeaders());
     ...
     * @return \Swagger\Client\Model\PaymentCardResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\PaymentCardResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function paymentsCardsIndexWithHttpInfo($partner_id = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PaymentCardResult',
                '/payments/cards'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PaymentCardResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PaymentCardResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param \Swagger\Client\Model\PaymentCardResource $payment_card_resource  (required)
     * @return \Swagger\Client\Model\PaymentCardResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * Create epay window.
     *
     * @param \Swagger\Client\Model\PaymentWindowResource $payment_window_resource  (required)
     * @return \Swagger\Client\Model\PaymentWindowResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     *
     * @param \Swagger\Client\Model\PaymentWindowResource $payment_window_resource  (required)
     * @return Array of \Swagger\Client\Model\PaymentWindowResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function paymentsEpayWindowCreateWithHttpInfo($payment_window_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PaymentWindowResource',
                '/payments/epay/window'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PaymentWindowResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PaymentWindowResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
