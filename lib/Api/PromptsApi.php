...
class PromptsApi
{
     ...
     * @param \Ageras\Api\Model\PromptActionResource $prompt_action_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\PromptResource
     */
     ...
     * @param \Ageras\Api\Model\PromptActionResource $prompt_action_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\PromptResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function promptsActionsCreateWithHttpInfo($prompt_id , $prompt_action_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\PromptResource',
                '/prompts/{prompt_id}/actions'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\PromptResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\PromptResource', $e->getResponseHeaders());
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\PromptResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\PromptResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function promptsIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\PromptResult',
                '/prompts'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\PromptResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\PromptResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
