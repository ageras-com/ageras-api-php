...
class RatingsApi
{
     ...
     * @return \Swagger\Client\Model\RatingResource
     ...
     *
     * @param string $rating_id The id the Rating to return (required)
     * @return Array of \Swagger\Client\Model\RatingResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function ratingsGetWithHttpInfo($rating_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\RatingResource',
                '/ratings/{rating_id}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\RatingResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\RatingResource', $e->getResponseHeaders());
     ...
     * @return \Swagger\Client\Model\RatingResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\RatingResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function ratingsIndexWithHttpInfo($partner_id = null, $rating_id = null, $sort = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\RatingResult',
                '/ratings'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\RatingResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\RatingResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param \Swagger\Client\Model\RatingResource $rating_resource  (required)
     * @return \Swagger\Client\Model\RatingResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
