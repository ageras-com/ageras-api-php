...
class RefundsApi
{
     ...
     * @return \Ageras\Api\Model\RefundResource
     */
     ...
     *
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\RefundResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function refundsCreateWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\RefundResource',
                '/refunds'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\RefundResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\RefundResource', $e->getResponseHeaders());
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\RefundResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\RefundResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function refundsIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\RefundResult',
                '/refunds'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\RefundResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\RefundResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
