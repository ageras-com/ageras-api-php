...
class TasksApi
{
     ...
     * Create a new task.
     *
     * @param \Ageras\Api\Model\TaskResource $task_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\TaskResource
     */
     ...
     * @param \Ageras\Api\Model\TaskResource $task_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\TaskResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function tasksCreateWithHttpInfo($task_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\TaskResource',
                '/tasks'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\TaskResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\TaskResource', $e->getResponseHeaders());
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\TaskResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\TaskResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function tasksIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\TaskResult',
                '/tasks'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\TaskResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\TaskResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\TaskPriorityResource
     */
     ...
     * @param string $priority_id 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\TaskPriorityResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function tasksPrioritiesGetWithHttpInfo($priority_id )
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\TaskPriorityResource',
                '/tasks/priorities/{priority_id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\TaskPriorityResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\TaskPriorityResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\TaskPriorityResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\TaskPriorityResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function tasksPrioritiesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\TaskPriorityResult',
                '/tasks/priorities'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\TaskPriorityResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\TaskPriorityResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\TaskStatusResource
     */
     ...
     * @param string $status_id 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\TaskStatusResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function tasksStatusesGetWithHttpInfo($status_id )
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\TaskStatusResource',
                '/tasks/statuses/{status_id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\TaskStatusResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\TaskStatusResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\TaskStatusResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\TaskStatusResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function tasksStatusesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\TaskStatusResult',
                '/tasks/statuses'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\TaskStatusResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\TaskStatusResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param string $task_id 
     * @param \Ageras\Api\Model\TaskableResource $taskable_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\TaskableResource
     */
     ...
     * @param \Ageras\Api\Model\TaskableResource $taskable_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\TaskableResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function tasksTaskablesCreateWithHttpInfo($task_id , $taskable_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\TaskableResource',
                '/tasks/{task_id}/taskables'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\TaskableResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\TaskableResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return \Ageras\Api\Model\TaskableResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\Model\TaskableResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function tasksTaskablesIndexWithHttpInfo($task_id , $criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\Model\TaskableResult',
                '/tasks/{task_id}/taskables'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\Model\TaskableResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\Model\TaskableResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
