...
class TasksApi
{
     ...
     * Create a new task.
     *
     * @param \Swagger\Client\Model\TaskResource $task_resource  (required)
     * @return \Swagger\Client\Model\TaskResource
     ...
     *
     * @param \Swagger\Client\Model\TaskResource $task_resource  (required)
     * @return Array of \Swagger\Client\Model\TaskResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function tasksCreateWithHttpInfo($task_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\TaskResource',
                '/tasks'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TaskResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\TaskResource', $e->getResponseHeaders());
     ...
     * @return \Swagger\Client\Model\TaskResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\TaskResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function tasksIndexWithHttpInfo($task_id = null, $geo_code = null, $employee_id = null, $completed_by_employee_id = null, $assigned_employee_id = null, $partner_id = null, $lead_id = null, $status = null, $limit = null, $include_done = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\TaskResult',
                '/tasks'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TaskResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\TaskResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Swagger\Client\Model\TaskPriorityResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     *
     * @param string $priority_id  (required)
     * @return Array of \Swagger\Client\Model\TaskPriorityResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function tasksPrioritiesGetWithHttpInfo($priority_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\TaskPriorityResource',
                '/tasks/priorities/{priority_id}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TaskPriorityResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\TaskPriorityResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return \Swagger\Client\Model\TaskPriorityResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\TaskPriorityResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function tasksPrioritiesIndexWithHttpInfo($priority_id = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\TaskPriorityResult',
                '/tasks/priorities'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TaskPriorityResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\TaskPriorityResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Swagger\Client\Model\TaskStatusResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     *
     * @param string $status_id  (required)
     * @return Array of \Swagger\Client\Model\TaskStatusResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function tasksStatusesGetWithHttpInfo($status_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\TaskStatusResource',
                '/tasks/statuses/{status_id}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TaskStatusResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\TaskStatusResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return \Swagger\Client\Model\TaskStatusResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\TaskStatusResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function tasksStatusesIndexWithHttpInfo($status_id = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\TaskStatusResult',
                '/tasks/statuses'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TaskStatusResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\TaskStatusResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param string $task_id  (required)
     * @param \Swagger\Client\Model\TaskableResource $taskable_resource  (required)
     * @return \Swagger\Client\Model\TaskableResource
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $task_id  (required)
     * @param \Swagger\Client\Model\TaskableResource $taskable_resource  (required)
     * @return Array of \Swagger\Client\Model\TaskableResource, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function tasksTaskablesCreateWithHttpInfo($task_id, $taskable_resource)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\TaskableResource',
                '/tasks/{task_id}/taskables'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TaskableResource', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\TaskableResource', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return \Swagger\Client\Model\TaskableResult
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $page The page position in the result. (optional)
     * @param string $query The search wildcard. (optional)
     * @return Array of \Swagger\Client\Model\TaskableResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function tasksTaskablesIndexWithHttpInfo($task_id, $taskable_id = null, $limit = null, $page = null, $query = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\TaskableResult',
                '/tasks/{task_id}/taskables'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TaskableResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\TaskableResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
