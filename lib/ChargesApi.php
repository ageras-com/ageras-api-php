...
class ChargesApi
{
     ...
     * @return \Ageras\Api\ChargeResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\ChargeResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function chargesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\ChargeResult',
                '/charges'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\ChargeResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\ChargeResult', $e->getResponseHeaders());
