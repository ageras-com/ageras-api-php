...
class DatafieldsApi
{
     ...
     * @return \Ageras\Api\DataFieldResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\DataFieldResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function datafieldsIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\DataFieldResult',
                '/datafields'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\DataFieldResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\DataFieldResult', $e->getResponseHeaders());
