...
class DataFieldResource implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'geo' => '\Ageras\Api\Model\DataFieldGeoResource',
        'identifier' => 'string',
        'label' => 'string',
        'type' => 'string',
        'required' => 'bool',
        'priority' => 'int',
        'is_internal' => 'bool',
        'values' => '\Ageras\Api\Model\DataFieldValueResource[]',
        'is_active' => 'bool',
        'created_at' => 'string',
        'updated_at' => 'string',
        'category' => 'string',
    ...
    /**
     * Gets geo
     * @return \Ageras\Api\Model\DataFieldGeoResource
     */
    ...
    /**
     * Sets geo
     * @param \Ageras\Api\Model\DataFieldGeoResource $geo
     * @return $this
     */
    ...
    /**
     * Sets values
     * @param \Ageras\Api\Model\DataFieldValueResource[] $values
     * @return $this
     */
