...
/**
 * LeadQuoteItemResult Class Doc Comment
 *
 * @category    Class
 * @package     Ageras\Api
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LeadQuoteItemResult implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LeadQuoteItemResult';
    ...
    protected static $swaggerTypes = [
        ...
        'pages' => 'int',
        'total' => 'int',
        'data' => '\Ageras\Api\Model\LeadQuoteItemResource[]',
        'did_you_mean' => 'string'
    ];
    ...
    /**
     * Sets data
     * @param \Ageras\Api\Model\LeadQuoteItemResource[] $data The result.
     * @return $this
     */
