...
/**
 * LeadQuoteResult Class Doc Comment
 *
 * @category    Class
 * @package     Ageras\Api
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LeadQuoteResult implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LeadQuoteResult';
    ...
    protected static $swaggerTypes = [
        ...
        'pages' => 'int',
        'total' => 'int',
        'data' => '\Ageras\Api\Model\LeadQuoteResource[]',
        'did_you_mean' => 'string'
    ];
    ...
    /**
     * Sets data
     * @param \Ageras\Api\Model\LeadQuoteResource[] $data The result.
     * @return $this
     */
