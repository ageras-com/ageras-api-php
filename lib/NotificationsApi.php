...
class NotificationsApi
{
    ...
    public function notificationsActionsCreateWithHttpInfo($notification_action_resource)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\NotificationResource', $httpHeader), $statusCode, $httpHeader];
    ...
    public function notificationsIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\NotificationResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
