...
class OffersApi
{
    ...
    public function offersActionsCreateWithHttpInfo($offer_id , $offer_action_resource)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\PartnerOfferResource', $httpHeader), $statusCode, $httpHeader];
    ...
    public function offersIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\PartnerOfferResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
