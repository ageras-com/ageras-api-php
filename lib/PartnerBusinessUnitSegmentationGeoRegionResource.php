<?php
/**
 * PartnerBusinessUnitSegmentationGeoRegionResource
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PartnerBusinessUnitSegmentationGeoRegionResource Class Doc Comment
 *
 * @category    Class
 * @package     Ageras\Api
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PartnerBusinessUnitSegmentationGeoRegionResource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartnerBusinessUnitSegmentationGeoRegionResource';
    ...
    /**
     * Sets id
     * @param int $id Segmentation geo region ID.
     * @return $this
     */
    ...
    /**
     * Sets region_name
     * @param string $region_name @var Human readable region name.
     * @return $this
     */
