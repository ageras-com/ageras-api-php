...
/**
 * PartnerRevenueSegmentResult Class Doc Comment
 *
 * @category    Class
 * @package     Ageras\Api
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PartnerRevenueSegmentResult implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartnerRevenueSegmentResult';
    ...
    protected static $swaggerTypes = [
        ...
        'pages' => 'int',
        'total' => 'int',
        'data' => '\Ageras\Api\PartnerRevenueSegmentResource[]',
        'did_you_mean' => 'string'
    ];
    ...
    /**
     * Sets data
     * @param \Ageras\Api\PartnerRevenueSegmentResource[] $data The result.
     * @return $this
     */
