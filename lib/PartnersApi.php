...
class PartnersApi
{
    ...
    /**
     * Operation partnersActionfeesIndex
     *
     * 
     *
     ...
     * @return \Ageras\Api\PartnerActionFeesResult
     */
    public function partnersActionfeesIndex($partner_id , $criteria = [])
    {
        list($response) = $this->partnersActionfeesIndexWithHttpInfo($partner_id, $criteria);
        return $response;
    }

    /**
     * Operation partnersActionfeesIndexWithHttpInfo
     *
     * 
     *
     * @param string $partner_id 
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\PartnerActionFeesResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function partnersActionfeesIndexWithHttpInfo($partner_id , $criteria = [])
    {
        // parse inputs
        $resourcePath = "/partners/{partner_id}/actionfees";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\PartnerActionFeesResult',
                '/partners/{partner_id}/actionfees'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\PartnerActionFeesResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\PartnerActionFeesResult', $e->getResponseHeaders());
