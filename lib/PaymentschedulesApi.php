...
class PaymentschedulesApi
{
     ...
     * @return \Ageras\Api\PartnerPaymentScheduleResult
     */
     ...
     * ]
     * @throws \Ageras\Api\ApiException on non-2xx response
     * @return array of \Ageras\Api\PartnerPaymentScheduleResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentschedulesIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\PartnerPaymentScheduleResult',
                '/paymentschedules'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\PartnerPaymentScheduleResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\PartnerPaymentScheduleResult', $e->getResponseHeaders());
