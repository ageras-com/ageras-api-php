...
class PromptResource implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'id' => 'int',
        'attributes' => '\Ageras\Api\PromptAttributeResource[]',
        'type' => 'string',
        'trigger' => 'string',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['receiver_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'receiver_type', must be one of #{allowed_values}.";
        }
    ...
    /**
     * Gets attributes
     * @return \Ageras\Api\PromptAttributeResource[]
     */
    ...
    /**
     * Sets attributes
     * @param \Ageras\Api\PromptAttributeResource[] $attributes Attributes
     * @return $this
     */
    ...
    {
        $allowed_values = array('unknown', 'partner', 'partner_user');
        if (!in_array($receiver_type, $allowed_values)) {
