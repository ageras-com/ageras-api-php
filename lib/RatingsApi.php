...
class RatingsApi
{
    ...
    public function ratingsGetWithHttpInfo($rating_id )
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\RatingResource', $httpHeader), $statusCode, $httpHeader];
    ...
    public function ratingsIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\RatingResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
