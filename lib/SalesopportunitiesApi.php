...
class SalesopportunitiesApi
{
    ...
    public function salesOpportunitiesAggregationsIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\SalesOpportunityResult', $httpHeader), $statusCode, $httpHeader];
     ...
     *
     * @param \Ageras\Api\SalesOpportunityResource $sales_opportunity_resource 
     * @throws \Ageras\Api\ApiException on non-2xx response
    ...
    public function salesOpportunitiesCreateWithHttpInfo($sales_opportunity_resource)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\SalesOpportunityResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
