...
class SearchApi
{
    ...
    public function searchIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\SearchResult', $httpHeader), $statusCode, $httpHeader];
    ...
    public function searchTypeaheadIndexWithHttpInfo($criteria = [])
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\TypeaheadResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
