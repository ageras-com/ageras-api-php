...
/**
 * SegmentationGeoRegionResult Class Doc Comment
 *
 * @category    Class
 * @package     Ageras\Api
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SegmentationGeoRegionResult implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SegmentationGeoRegionResult';
    ...
    protected static $swaggerTypes = [
        ...
        'pages' => 'int',
        'total' => 'int',
        'data' => '\Ageras\Api\SegmentationGeoRegionResource[]',
        'did_you_mean' => 'string'
    ];
    ...
    /**
     * Sets data
     * @param \Ageras\Api\SegmentationGeoRegionResource[] $data The result.
     * @return $this
     */
