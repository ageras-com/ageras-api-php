...
class TasksApi
{
     ...
     * @param string $sort  (optional, default to deadline_at)
     ...
     * @throws \Ageras\Api\ApiException on non-2xx response
     */
    public function tasksIndex($task_id = null, $geo_code = null, $employee_id = null, $completed_by_employee_id = null, $assigned_employee_id = null, $partner_id = null, $lead_id = null, $status = null, $limit = null, $include_done = null, $process = null, $due_before = null, $sort = null, $page = null, $query = null)
    {
        list($response) = $this->tasksIndexWithHttpInfo($task_id, $geo_code, $employee_id, $completed_by_employee_id, $assigned_employee_id, $partner_id, $lead_id, $status, $limit, $include_done, $process, $due_before, $sort, $page, $query);
        return $response;
    }
     ...
     * @throws \Ageras\Api\ApiException on non-2xx response
     */
    public function tasksIndexWithHttpInfo($task_id = null, $geo_code = null, $employee_id = null, $completed_by_employee_id = null, $assigned_employee_id = null, $partner_id = null, $lead_id = null, $status = null, $limit = null, $include_done = null, $process = null, $due_before = null, $sort = null, $page = null, $query = null)
    {
        // parse inputs
        $resourcePath = "/tasks";
        $httpBody = '';
