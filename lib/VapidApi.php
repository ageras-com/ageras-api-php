...
class VapidApi
{
     ...
     */
    public function vapidGet()
    {
        list($response) = $this->vapidGetWithHttpInfo();
        return $response;
    }
     ...
     */
    public function vapidGetWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/vapid";
        $httpBody = '';
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Ageras\Api\VapidResource',
                '/vapid'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Ageras\Api\VapidResource', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Ageras\Api\VapidResource', $e->getResponseHeaders());
